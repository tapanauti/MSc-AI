...
def stochastic(x):
    ...
    # it is "cheating" for Q7 because there is no real dependency!  we
    # could make a **memoised** version of this, removing
    # stochasticity, but still very difficult. We'll discuss
    # memoisation later in CT5132.
