...
#             best = np.mean(err_best_g)
#             self.all_best.append([i,best])
...
# #--- EXECUTE
# obj = []
# initial=[5,5,5,5,5,5]               # initial starting location [x1,x2...]
# bounds=[(-100,100),(-100,100),(-100,100),(-100,100),(-100,100),(-100,100)] 
# for i in range(0,4):
#     random.seed(i)
#     obj_best = PSO(func1,initial,bounds,num_particles=15,maxiter=50000)
#     obj = np.array(obj_best.all_best)
